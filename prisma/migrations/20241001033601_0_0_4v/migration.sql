...
CREATE TABLE `Project` (
    ...
    INDEX `Project_userId_name_idx`(`userId`, `name`),
    PRIMARY KEY (`id`)
...
CREATE TABLE `Category` (
    ...
    INDEX `Category_name_projectId_idx`(`name`, `projectId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- CreateIndex
CREATE INDEX `OAuthProvider_userId_provider_idx` ON `OAuthProvider`(`userId`, `provider`);
